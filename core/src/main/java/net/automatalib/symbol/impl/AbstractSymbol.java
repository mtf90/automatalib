 ...
 */
package net.automatalib.symbol.impl;
...
public abstract class AbstractSymbol implements ParameterizedSymbol {

    private final String name;
    private final DataType<?>[] ptypes;

    public AbstractSymbol(String name, DataType<?>... ptypes) {
        this.name = name;
        this.ptypes = ptypes;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final AbstractSymbol other = (AbstractSymbol) obj;
