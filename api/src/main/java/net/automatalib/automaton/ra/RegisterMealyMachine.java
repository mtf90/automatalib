...
public interface RegisterMealyMachine<L, A extends ParameterizedSymbol, T extends GuardedOutputTransition, O extends ParameterizedSymbol>
    ...
    @Override
    default UniversalGraph<L, TransitionEdge<A, T>, Void, Property<A, O>> transitionGraphView(Collection<? extends A> inputs) {
        return new RegisterMealyMachineGraphView<>(this, inputs);
    }
}
