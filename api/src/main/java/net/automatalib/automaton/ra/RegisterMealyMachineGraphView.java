...
public class RegisterMealyMachineGraphView<S, I, T extends GuardedOutputTransition, SP, TP, A extends UniversalAutomaton<S, I, T, SP, TP>>
        extends UniversalAutomatonGraphView<S, I, T, SP, TP, A> {

    public RegisterMealyMachineGraphView(A automaton, Collection<? extends I> inputs) {
    ...
    public VisualizationHelper<S, TransitionEdge<I, T>> getVisualizationHelper() {
        return new AutomatonVisualizationHelper<>(automaton) {
            ...
            public boolean getEdgeProperties(S src, TransitionEdge<I, T> edge, S tgt, Map<String, String> properties) {
                ...
                final TP output = automaton.getTransitionProperty(transition);

                super.getEdgeProperties(src, edge, tgt, properties);

                properties.put(EdgeAttrs.LABEL,
                               input + ", " + transition.getGuard() + ", " + output + ", " +
                               transition.getAssignment());
