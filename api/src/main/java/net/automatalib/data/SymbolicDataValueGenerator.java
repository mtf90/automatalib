...
public abstract class SymbolicDataValueGenerator {
    ...
    public static final class FreshOutputGenerator extends SymbolicDataValueGenerator {
        @Override
        public <T> SymbolicDataValue.FreshOutput<T> next(DataType<T> type) {
            return new SymbolicDataValue.FreshOutput<>(type, id++);
        }
    };
}
