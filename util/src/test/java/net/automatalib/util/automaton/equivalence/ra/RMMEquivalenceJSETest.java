...
import net.automatalib.util.automaton.equivalence.jse.RMMEquivalenceJSE;
import net.automatalib.word.Word;

public class RMMEquivalenceJSETest extends AbstractRMMEquivalenceTest {

    @Override
    protected EquivalenceChecker<InputSymbol, OutputSymbol> getChecker() {
        return new RMMChecker1<>();
    }

    private static class RMMChecker1<I extends ParameterizedSymbol, O extends ParameterizedSymbol>
            implements AbstractRMMEquivalenceTest.EquivalenceChecker<I, O> {
        ...
        public Word<SymbolInstance<I>> findSeparatingWord(RegisterMealyMachine<?, I, ?, O> hyp,
            ...
            return RMMEquivalenceJSE.findSeparatingWord(hyp, model, inputs, solver);
        }
